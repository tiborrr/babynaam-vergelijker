...
(function () {
    ...
    const TRANSLATIONS = {
        en: {
            ...
            tabStarterPacks: "⚡ Top Starter Lists",
            tabPasteCustom: "📋 Paste Own List",
            loadCultureListBtn: "⚡ Load Top {count} {culture}",
            loadedListToast: "Loaded Top {count} {culture} names",
            pasteAreaLabel: "Paste your names (one per line or comma-separated):",
            usePastedListBtn: "Use this list ({count} names) →",
            emptyStateQuestion: "Your list is empty. How would you like to start?",
            emptyQuickLoad: "⚡ Load Top 50 {culture}",
            emptyQuickPaste: "📋 Paste My Own List",
            topListsSub: 'Click to append',
            candidateNamesLabel: 'Candidate Names',
            quickAddPlaceholder: 'Type a name & press Enter (or paste)...',
            addBtn: 'Add',
            bulkEdit: 'Bulk Edit',
            emptyNamesNotice: 'No names added yet. Type a name above or pick a Top List!',
            inspirationsTitle: '💡 Suggestions for your list',
            ...
            grandFinal: "🏆 The Grand Final",
            bronzeMatch: "🥉 3rd Place Match",
            semifinals: "Semifinals (Top 4)",
            quarterfinals: "Quarterfinals (Top 8)",
            roundOfCount: "Round {round}: {count} names",
            roundMilestone: "🎉 Round {round} complete! {count} favorites advance.",
            tournamentProgress: "Duel {current} of {roundTotal} · Match {totalCompleted}/{totalEstimated}",
            winnerAnnounce: "🎉 We have a champion! '{name}' is your #1 baby name!",
            ...
            quickComparePrompt: "Compare top favorites from {person1} & {person2}",
            compareNowBtn: "Compare Now",
            statusExactMatch: "Exact Match",
            statusGreatMatch: "Great Match",
        ...
        nl: {
            ...
            tabStarterPacks: "⚡ Top Namenlijsten",
            tabPasteCustom: "📋 Eigen lijst inplakken",
            loadCultureListBtn: "⚡ Laad Top {count} {culture}",
            loadedListToast: "Top {count} {culture} namen geladen",
            pasteAreaLabel: "Plak hier je namen (één per regel of met komma's gescheiden):",
            usePastedListBtn: "Gebruik deze lijst ({count} namen) →",
            emptyStateQuestion: "Je lijst is nog leeg. Hoe wil je beginnen?",
            emptyQuickLoad: "⚡ Laad Top 50 {culture}",
            emptyQuickPaste: "📋 Plak mijn eigen lijst",
            topListsSub: 'Klik om toe te voegen',
            candidateNamesLabel: 'Namenlijst',
            quickAddPlaceholder: 'Typ een naam & druk Enter (of plak)...',
            addBtn: 'Toevoegen',
            bulkEdit: 'Lijst Bewerken',
            emptyNamesNotice: 'Nog geen namen toegevoegd. Typ een naam of kies een Toplijst!',
            inspirationsTitle: '💡 Suggesties voor jouw lijst',
            ...
            grandFinal: "🏆 De Grote Finale",
            bronzeMatch: "🥉 Troostfinale (Plek 3 & 4)",
            semifinals: "Halve Finale (Top 4)",
            quarterfinals: "Kwartfinale (Top 8)",
            roundOfCount: "Ronde {round}: {count} namen",
            roundMilestone: "🎉 Ronde {round} voltooid! {count} favorieten gaan door naar de volgende ronde.",
            tournamentProgress: "Duel {current} van {roundTotal} · Wedstrijd {totalCompleted}/{totalEstimated}",
            winnerAnnounce: "🎉 We hebben een winnaar! '{name}' is jouw #1 babynaam!",
            ...
            quickComparePrompt: "Vergelijk de favorieten van {person1} & {person2}",
            compareNowBtn: "Vergelijk Nu",
            statusExactMatch: "Exacte Match",
            statusGreatMatch: "Top Match",
        ...
        fr: {
            ...
            tabStarterPacks: "⚡ Listes Populaires",
            tabPasteCustom: "📋 Coller votre liste",
            loadCultureListBtn: "⚡ Charger le Top {count} {culture}",
            loadedListToast: "Top {count} {culture} prénoms chargés",
            pasteAreaLabel: "Collez vos prénoms (un par ligne ou séparés par des virgules) :",
            usePastedListBtn: "Utiliser cette liste ({count} prénoms) →",
            emptyStateQuestion: "Votre liste est vide. Comment souhaitez-vous commencer ?",
            emptyQuickLoad: "⚡ Charger le Top 50 {culture}",
            emptyQuickPaste: "📋 Coller ma propre liste",
            topListsSub: 'Cliquez pour ajouter',
            candidateNamesLabel: 'Liste des prénoms',
            quickAddPlaceholder: 'Tapez un prénom & Entrée (ou collez)...',
            addBtn: 'Ajouter',
            bulkEdit: 'Modifier la liste',
            emptyNamesNotice: 'Aucun prénom ajouté. Tapez un nom ou choisissez une liste !',
            inspirationsTitle: '💡 Suggestions pour votre liste',
            ...
            grandFinal: "🏆 La Grande Finale",
            bronzeMatch: "🥉 Petite Finale (3e place)",
            semifinals: "Demi-finales (Top 4)",
            quarterfinals: "Quarts de finale (Top 8)",
            roundOfCount: "Tour {round} : {count} prénoms",
            roundMilestone: "🎉 Tour {round} terminé ! {count} favoris qualifiés.",
            tournamentProgress: "Duel {current} sur {roundTotal} · Match {totalCompleted}/{totalEstimated}",
            winnerAnnounce: "🎉 Nous avons un gagnant ! '{name}' est votre prénom n°1 !",
            ...
            quickComparePrompt: "Comparez les favoris de {person1} & {person2}",
            compareNowBtn: "Comparer",
            statusExactMatch: "Match Parfait",
            statusGreatMatch: "Très Bon Match",
        ...
        es: {
            ...
            tabStarterPacks: "⚡ Listas Populares",
            tabPasteCustom: "📋 Pegar mi lista",
            loadCultureListBtn: "⚡ Cargar Top {count} {culture}",
            loadedListToast: "Top {count} {culture} nombres cargados",
            pasteAreaLabel: "Pega tus nombres (uno por línea o separados por comas):",
            usePastedListBtn: "Usar esta lista ({count} nombres) →",
            emptyStateQuestion: "Tu lista está vacía. ¿Cómo quieres empezar?",
            emptyQuickLoad: "⚡ Cargar Top 50 {culture}",
            emptyQuickPaste: "📋 Pegar mi propia lista",
            topListsSub: 'Haz clic para añadir',
            candidateNamesLabel: 'Lista de nombres',
            quickAddPlaceholder: 'Escribe un nombre y pulsa Enter...',
            addBtn: 'Añadir',
            bulkEdit: 'Editar lista',
            emptyNamesNotice: 'Aún no has añadido nombres. ¡Escribe arriba o elige una lista!',
            inspirationsTitle: '💡 Sugerencias para tu lista',
            ...
            grandFinal: "🏆 La Gran Final",
            bronzeMatch: "🥉 3.er Puesto",
            semifinals: "Semifinales (Top 4)",
            quarterfinals: "Cuartos de final (Top 8)",
            roundOfCount: "Ronda {round}: {count} nombres",
            roundMilestone: "🎉 ¡Ronda {round} completada! {count} favoritos avanzan.",
            tournamentProgress: "Duelo {current} de {roundTotal} · Partido {totalCompleted}/{totalEstimated}",
            winnerAnnounce: "🎉 ¡Tenemos un campeón! '{name}' es tu nombre #1!",
            ...
            quickComparePrompt: "Compara los favoritos de {person1} y {person2}",
            compareNowBtn: "Comparar Ahora",
            statusExactMatch: "Coincidencia Exacta",
            statusGreatMatch: "Gran Coincidencia",
        ...
        de: {
            ...
            tabStarterPacks: "⚡ Top-Listen",
            tabPasteCustom: "📋 Eigene Liste einfügen",
            loadCultureListBtn: "⚡ Top {count} {culture} laden",
            loadedListToast: "Top {count} {culture} Namen geladen",
            pasteAreaLabel: "Füge deine Namen ein (einer pro Zeile oder durch Kommas getrennt):",
            usePastedListBtn: "Diese Liste verwenden ({count} Namen) →",
            emptyStateQuestion: "Deine Liste ist leer. Wie möchtest du starten?",
            emptyQuickLoad: "⚡ Top 50 {culture} laden",
            emptyQuickPaste: "📋 Eigene Liste einfügen",
            topListsSub: 'Klicken zum Hinzufügen',
            candidateNamesLabel: 'Namensliste',
            quickAddPlaceholder: 'Name eingeben & Enter drücken...',
            addBtn: 'Hinzufügen',
            bulkEdit: 'Liste bearbeiten',
            emptyNamesNotice: 'Noch keine Namen hinzugefügt. Namen eingeben oder Top-Liste wählen!',
            inspirationsTitle: '💡 Vorschläge für deine Liste',
            namesCount: '({count} Namen)',
            ...
            grandFinal: "🏆 Das Große Finale",
            bronzeMatch: "🥉 Spiel um Platz 3",
            semifinals: "Halbfinale (Top 4)",
            quarterfinals: "Viertelfinale (Top 8)",
            roundOfCount: "Runde {round}: {count} Namen",
            roundMilestone: "🎉 Runde {round} beendet! {count} Favoriten sind weiter.",
            tournamentProgress: "Duell {current} von {roundTotal} · Match {totalCompleted}/{totalEstimated}",
            winnerAnnounce: "🎉 Wir haben einen Gewinner! '{name}' ist dein #1 Name!",
            ...
            quickComparePrompt: "Vergleiche die Favoriten von {person1} & {person2}",
            compareNowBtn: "Jetzt Vergleichen",
            statusExactMatch: "Exakte Übereinstimmung",
            statusGreatMatch: "Tolle Übereinstimmung",
        ...
        ar: {
            ...
            tabStarterPacks: "⚡ القوائم الشائعة",
            tabPasteCustom: "📋 لصق قائمتك الخاصة",
            loadCultureListBtn: "⚡ تحميل أفضل {count} {culture}",
            loadedListToast: "تم تحميل أفضل {count} أسماء {culture}",
            pasteAreaLabel: "الصق أسماءك هنا (اسم واحد في كل سطر أو مفصولة بفواصل):",
            usePastedListBtn: "استخدم هذه القائمة ({count} أسماء) ←",
            emptyStateQuestion: "قائمتك فارغة. كيف ترغب في البدء؟",
            emptyQuickLoad: "⚡ تحميل أفضل 50 {culture}",
            emptyQuickPaste: "📋 لصق قائمتي الخاصة",
            topListsSub: 'اضغط للإضافة',
            candidateNamesLabel: 'قائمة الأسماء',
            quickAddPlaceholder: 'اكتب اسماً واضغط Enter...',
            addBtn: 'إضافة',
            bulkEdit: 'تعديل القائمة',
            emptyNamesNotice: 'لم تتم إضافة أسماء بعد. اكتب اسماً أعلاه أو اختر قائمة!',
            inspirationsTitle: '💡 اقتراحات لقائمتك',
            ...
            bronzeMatch: "🥉 المركز الثالث",
            semifinals: "نصف النهائي (أفضل 4)",
            quarterfinals: "ربع النهائي (أفضل 8)",
            roundOfCount: "الجولة {round}: {count} أسماء",
            roundMilestone: "🎉 اكتملت الجولة {round}! تأهل {count} أسماء مفضلة.",
            tournamentProgress: "المباراة {current} من {roundTotal} · مواجهة {totalCompleted}/{totalEstimated}",
            winnerAnnounce: "🎉 لدينا فائز! '{name}' هو اختيارك الأول!",
            ...
            quickComparePrompt: "قارن الأسماء المفضلة بين {person1} و {person2}",
            compareNowBtn: "قارن الآن",
            statusExactMatch: "تطابق تام",
            statusGreatMatch: "تطابق رائع",
